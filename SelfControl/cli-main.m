...
int main(int argc, char* argv[]) {
    [SCSentry startSentry: @"org.dayloft.cli"];
    ...
    @autoreleasepool {
		...
		if([arguments booleanValueForSignature: startSig]) {
			...
			if([fileManager fileExistsAtPath: @"/Library/PrivilegedHelperTools/org.dayloft.Dayloft"]) {
				if(![fileManager removeItemAtPath: @"/Library/PrivilegedHelperTools/org.dayloft.Dayloft" error: nil]) {
