...
@interface AppController : NSObject <NSApplicationDelegate> {
	...
	IBOutlet NSButton* scheduleButton_;
...
// Saves the current block configuration and starts it automatically at a
// future date selected by the user.
...
// Uses one five-minute break from the active block's saved break budget.
- (void)takeBreakWithLock:(NSLock*)lock;
